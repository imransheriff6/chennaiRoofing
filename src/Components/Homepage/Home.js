...
function Home() {
  ...
  const Why_us_data = [
    {
      icon: <FaPeopleArrows />,
      content: "Lorem ipsum widjf jfwijin wifhwf nsjbche eijeivnnihoe op emvomdoisvm iivmkdnvoiivienn efdlkvno ojvdvoiv ejfionv jvjevo nfeinoei eovjeo eojveovhpe jvdn"
    },
    {
      icon: <FaPeopleArrows />,
      content: "Lorem ipsum widjf jfwijin wifhwf nsjbche eijeivnnihoe op emvomdoisvm iivmkdnvoiivienn efdlkvno ojvdvoiv ejfionv jvjevo nfeinoei eovjeo eojveovhpe jvdn"
    ...
    <div>
      ...
      <div className="Why_us">
        ...
        <div className="choose_wrap">{
          Why_us_data.map(e => <Why_us icon={e.icon} content={e.content} />)
        }</div>
      </div>
