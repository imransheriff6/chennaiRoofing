...
import bg4 from "../../Images/pre-engineered.jpg";
import bg5 from "../../Images/factory-shed.jpg";
import bg6 from "../../Images/mezzanine-floor.jpg";
import bg7 from "../../Images/industrial-shed.jpg";
import bg8 from "../../Images/warehouse.jpg";
import bg9 from "../../Images/metal building.jpg";
...
import BannerSlider from "../Slider/Banner/carousel";
import ProductGallery from "../Slider/products/gallery";
  ...
  const Why_us_data = [
    {
      ...
      content:
        "We use advanced technology, integrating automation processes to ensures precision and enhances project outcomes with the automation process.",
    },
    {
      icon: bg_icon2,
      title: "Excellent Client Service",
      content:
        "Ensuring client happiness is our priority. We value clear communication, active teamwork and surpassing your expectations throughout the project.",
    },
    {
      icon: bg_icon3,
      title: "On-time delivery",
      content:
        "As a result of our innovative project management systems, we can effectively shorten the project's duration while maintaining the safety protocols.",
    },
    {
      icon: bg_icon4,
      title: "Continuous Improvement",
      content:
        "Chennairoofings is passionate about continuous improvement and development in the sector, including the laws and practical solutions for projects.",
    },
  ];
  return (
    <div>
      <div className="Home">
        {pop ? (
          <div className="navbar-scroll" data-aos="fade-down">
        ...
        <div className="section1">
          ...
          <div className="part2">
            ...
            <p>
              ...
              Chennairoofings to shield your operations from the elements. You
              can choose from a variety of materials like durable metal sheets,
              ...
              services from installation and maintenance to emergency repairs
              and roof replacements. As a leading contractor we provide
              Pre-engineered Building(PEB), Factory sheds, Metal building,
              Industrial sheds, Warehouse shed, EOT shed and Mezzanine floor.
            </p>
          </div>
        </div>
        <div className="section2">
          <div className="part3">
            ...
            <p>
              ...
              solutions for businesses of all sizes. Choosing the right
              industrial roofing contractor is an investment in the longevity
              and productivity for your project management. We offer exceptional
              value with competitive pricing and comprehensive warranties. We
              also provide Marriage hall construction, Rice mill construction,
              Poultry &EC farm construction with transparent quotes and
              comprehensive warranties. Contact us today and experience the
              difference a reliable, expert roof makes.
            </p>
          </div>
      ...
      <div className="Why_us">
        ...
        <div className="choose_wrap">
          {Why_us_data.map((e) => (
            <Why_us title={e.title} icon={e.icon} content={e.content} />
          ))}
        </div>
      </div>
      <div className="location">
        ...
        <div className="part2">
          <div>
            <h1>Our Branches</h1>
            <p>
              Chennai Roofing is the leading industrial roofing contractor in
              Tamil Nadu. Our main branch is located in Chennai. We provide
